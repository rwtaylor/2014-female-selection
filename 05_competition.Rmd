...
```{r figures_blups, tidy=TRUE, tidy_source=list(blank=TRUE, width.cutoff=60), cache=FALSE}
library(effects)
library(ggplot2)
...
```{r tile_plot, tidy=TRUE, tidy_source=list(blank=TRUE, width.cutoff=60), cache=FALSE}
n = 12
e <- Effect(c("aggression_s", "activity_s", "competition_s"), g.ows,
