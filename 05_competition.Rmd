...
```{r 05_agg_comp_mcmc, fig.height=2.3, fig.width=2.17}
...
```{r 05_act_comp_mcmc, fig.height=2.3, fig.width=2.17}
...
```{r 05_doc_comp_mcmc, fig.height=2.3, fig.width=2.17}
...
```{r 05_agg_comp_blup, fig.height=2.3, fig.width=2.17}
...
```{r 05_act_comp_blup, fig.height=2.3, fig.width=2.17}
...
```{r 05_doc_comp_blup, fig.height=2.3, fig.width=2.17}
...
pdf("figure/05_quad.pdf", width = 3.14, height = 2)
quad_plot
dev.off()

```
```{r 05_quad, fig.width=3.14, fig.height=2}
quad_plot
```
...
pdf("figure/05_tile.pdf", width = 3.14, height = 3.14)
tile_plot
dev.off()
```

```{r 05_tile, fig.width=3.14, fig.height=3.14}
tile_plot
```