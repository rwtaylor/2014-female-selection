...
### Plots
```{r 04_sg_mcmc_SD, fig.cap="SD Standardized Selection Gradients"}
load("data/analyses_data/sel_grads_mcmc_post.RData")
library(ggplot2)
library(dplyr)
...
pdf(file = "figure/04_sg_mcmc_SD.pdf", width = 4.33, height = 3)
p_sel_grad_MCMC
dev.off()
p_sel_grad_MCMC
```

```{r 04_sg_mcmc_NS, fig.cap="Non-standardized Selection Gradients"}
load("data/analyses_data/sel_grads_mcmc_post.RData")
library(ggplot2)
library(dplyr)
...
pdf(file = "figure/04_sg_mcmc_NS.pdf", width = 4.33, height = 3)
p_sel_grad_MCMC
dev.off()
p_sel_grad_MCMC
```
...
```{r 04_agg_act_mcmc, fig.height=2.03, fig.width=2.17}
...
```{r 04_agg_doc_mcmc, fig.height=2.03, fig.width=2.17}
...
```{r 04_act_doc_mcmc, fig.height=2.03, fig.width=2.17}
...
```{r 04_sg_blup_SD, fig.width=6, fig.height=4}
load("data/analyses_data/sel_grads_blup.RData")
...
pdf(file = "figure/04_sg_blup_SD.pdf", width = 4.33, height = 3)
...
#### Aggression and Activity
```{r 04_agg_act_blup, fig.height=2.03, fig.width=2.17}
...
#### Aggression and Docility
```{r 04_agg_doc_blup, fig.height=2.03, fig.width=2.17}
...
#### Activity and Docility
```{r 04_act_doc_blup, fig.height=2.03, fig.width=2.17}
...
### Aggression plot
```{r 04_compare_agg, fig.height=2.3, fig.width=2.17}
...
### Activity Plot
```{r 04_compare_act, fig.height=2.3, fig.width=2.17}
...
### Docility Plot
```{r 04_compare_doc, fig.height=2.3, fig.width=2.17}
