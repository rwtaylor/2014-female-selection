...
save(doc_mcmc_model, file = "data/analysis_steps/doc_mcmc_model.RData")
```
...
load("data/analysis_steps/doc_mcmc_model.RData")
...
save(doc_mcmc_model_across,
  file = "data/analysis_steps/doc_mcmc_model_across.RData")
```

```{r doc_across_table, results='asis'}
load("data/analysis_steps/doc_mcmc_model_across.RData")
...
save(doc_mcmc_model_within,
  file = "data/analysis_steps/doc_mcmc_model_within.RData")
```

```{r doc_within.table, results='asis'}
load("data/analysis_steps/doc_mcmc_model_within.RData")
...
save(agg_mcmc_model, file = "data/analysis_steps/agg_mcmc_model.RData")
```

### Aggression Repeatability
```{r aggression_repeatability, results='asis'}
load("data/analysis_steps/agg_mcmc_model.RData")
...
save(agg_mcmc_model_across,
  file = "data/analysis_steps/agg_mcmc_model_across.RData")
```

```{r agg_across_table, results='asis'}
load("data/analysis_steps/agg_mcmc_model_across.RData")
...
save(agg_mcmc_model_within,
  file = "data/analysis_steps/agg_mcmc_model_within.RData")
```

```{r agg_within.table, results='asis'}
load("data/analysis_steps/agg_mcmc_model_within.RData")
...
save(act_mcmc_model, file = "data/analysis_steps/act_mcmc_model.RData")
```

### Activity Repeatability
```{r activity_repeatability, results='asis'}
load("data/analysis_steps/act_mcmc_model.RData")
...
save(act_mcmc_model_across,
  file = "data/analysis_steps/act_mcmc_model_across.RData")
```

```{r act_across_table, results='asis'}
load("data/analysis_steps/act_mcmc_model_across.RData")
...
save(act_mcmc_model_within,
  file = "data/analysis_steps/act_mcmc_model_within.RData")
```

```{r act_within.table, results='asis'}
load("data/analysis_steps/act_mcmc_model_within.RData")
...
save(doc_lmer_model, file = "data/analysis_steps/doc_lmer_model.RData")
```
### Aggression
```{r lmer_agg}
agg_data <- pca_data %>% filter(!is.na(misPC1))
...
save(agg_lmer_model, file = "data/analysis_steps/agg_lmer_model.RData")
```
### Activity
```{r lmer_act}
act_data <- pca_data %>% filter(!is.na(ofPC1))
...
save(act_lmer_model, file = "data/analysis_steps/act_lmer_model.RData")
```
...
save(mcmc_raneffs, file = "data/analysis_steps/MCMCraneffs.RData")
```

### from lmer models
```{r extract_lmer}
load("data/analysis_steps/doc_lmer_model.RData")
load("data/analysis_steps/agg_lmer_model.RData")
load("data/analysis_steps/act_lmer_model.RData")
...
save(lmer_blups, file = "data/analysis_steps/lmer_blups.RData")
```


### rbind MCMC raneffs and BLUPs
```{r rbind_mcmc_blups}
load("data/analysis_steps/MCMCraneffs.RData")
load("data/analysis_steps/lmer_blups.RData")
raneffs_blups <- rbind(mcmc_raneffs, lmer_blups)

save(raneffs_blups, file = "data/analysis_steps/raneffs_blups.RData")
``` 
